  ...
  return (
    ...
    >
      <div className="pt-36">
        ...
        <h2 className="text-white text-center text-2xl sm:text-4xl font-bold mb-3">{header}</h2>
        <p className="text-white text-center w-[350px] pb-[30px] sm:w-[650px] lg:w-[800px] mx-auto text-sm">{param}</p>
