...
const Contact = () => {
    ...
    <>
        <main className='w-full'>   
            ...
            <section className="flex items-center justify-center gap-10 bg-gray-200 p-7 pb-10 rounded-lg shadow-lg my-14 mx-auto sm:w-full md:w-3/4 lg:w-1/2">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="rounded-full">
                            ...
                            <form className="grid grid-rows-4 gap-3 h-auto bg-gray-200 p-3 rounded-lg shadow-lg sm:max-w-[768px] md:w-3/4 lg:w-4/5">  
                                ...
                                <button type='submit' className="hover:duration-700 ease-in-out bg-[#0029FF] hover:bg-white shadow-lg font-poppins text-white hover:text-[#0029FF] py-2 rounded-md text-center font-semibold">Submit</button>
                            </form>           
                    </div>
                            <div className="flex items-center justify-evenly gap-4 bg-[#0029FF] rounded-md sm:gap-6 md:gap-8 lg:gap-10">
                                <div className="flex items-center gap-3 cursor-pointer">
                                    <img className="my-5 w-7 h-7" src={mail_icon} />
                                    <p className="font-poppins text-white text-lg italic">oge.akomah@dartcomprojects.com</p>
                                </div>
