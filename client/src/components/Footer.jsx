      ...
      <div className="container mx-auto px-4 bg-[#2D3E4E] py-4">
        <div className="flex justify-between flex-col md:flex-row gap-16">
          ...
          <div>
            ...
            <ul>
              <li onClick={()=>handleNavigation('/services')}>Our Services</li>
