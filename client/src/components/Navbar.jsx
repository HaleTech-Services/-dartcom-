...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="w-full h-[80px] bg-white flex items-center justify-between px-[2rem] fixed top-0 right-0 left-0 z-10">
        ...
        <ul className="md:flex items-center gap-12 hidden ">
            ...
            <Link
              ...
              className={`${
                location.pathname === path
                  ? "text-white bg-[#4D69FF] p-3 rounded-md font-semibold relative"
                  : "text-[#333333]"
              }`}
            >
              {name}
          ...
          <button className="text-white bg-[#4D68FF] px-8 py-2 rounded-sm font-medium md:ml-auto">
