...
export default function HomeBanner() {
  return (
    <div className="relative w-full mb-[5rem]">
      ...
      <div className="info-container w-[90%] md:w-[60%] bg-white absolute -bottom-[20%] md:-bottom-[10%] left-1/2 -translate-x-1/2 bottom-shadow flex items-center justify-between p-8 mb-3 translate-y-4 md:translate-y-0 gap-3">
        <div className="info-item flex flex-col md:flex-row items-center justify-center">
          <span className="info-number text-[#FF7B00] text-2xl font-bold">
            25+
          </span>
          <span className="info-text text-sm md:text-base">
            Years of experience
          </span>
        </div>
        <div className="info-item flex flex-col md:flex-row items-center justify-center">
